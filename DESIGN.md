...
colors:
  white: "#FFFFFF"
  bg-page-light: "#FFF9F7"
  bg-container-light: "#FFFFFF"
  bg-hover-light: "#FFF0F3"
  bg-page-dark: "#1A1520"
...
间距以 **4px 为基数**：`4 / 8 / 12 / 16 / 20 / 24 / 32 / 40 / 48`。全主题统一。
