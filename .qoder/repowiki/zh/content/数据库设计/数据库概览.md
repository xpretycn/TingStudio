...
- [init.sql:7-227](file://backend/src/scripts/init.sql#L7-L227)
...
- [init.sql:7-48](file://backend/src/scripts/init.sql#L7-L48)
...
**章节来源**
- [DATABASE_DOC.md:172-217](file://backend/DATABASE_DOC.md#L172-L217)
- [init.sql:96-128](file://backend/src/scripts/init.sql#L96-L128)
...
**章节来源**
- [DATABASE_DOC.md:270-342](file://backend/DATABASE_DOC.md#L270-L342)
- [init.sql:171-197](file://backend/src/scripts/init.sql#L171-L197)
...
**图表来源**
- [DATABASE_DOC.md:390-424](file://backend/DATABASE_DOC.md#L390-L424)
- [init.sql:7-227](file://backend/src/scripts/init.sql#L7-L227)
...
这个数据库设计方案为 TingStudio 提供了稳定可靠的数据存储基础，支持从个人使用到中小规模团队协作的各种应用场景。