...
5. **配方名称**：优先从文件名提取，其次从文档标题或内容中提取
6. **description（重要）**：基于配方的原料组成、含量比等信息，生成一段简短的配方评估描述，内容包括：
...
则应输出：
{"name":"人参","protein":8.5,"fat":1.2,"carbohydrate":68,"sodium":12}
...
正确输出应该是：
{"name":"佛手","protein":1.2,"fat":7.7,"carbohydrate":92,"sodium":0}
